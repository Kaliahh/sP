...
\title{NumberSeries}
\author{Ane Søgaard Jørgensen}
\begin{document}
\maketitle
\lstinputlisting[style=colorC++,caption={NumberSeries.h}]{./NumberSeries.h}
\lstinputlisting[style=colorC++,caption={NumberSeries.cpp}]{./NumberSeries.cpp}
\lstinputlisting[style=colorC++,caption={NumberSeriesWrapper.cpp}]{./NumberSeriesWrapper.cpp}
\lstinputlisting[style=colorC++,caption={NumberSeriesWrapper.h}]{./NumberSeriesWrapper.h}
