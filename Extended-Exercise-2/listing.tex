...
\title{Calculator}
\author{Alexander Nykjær \\ Ane Søgaard Jørgensen \\ Jakob Sønderby Kristensen \\ Mikael Vind Mikkelsen \\ Trine Juhl Holmager}
\begin{document}
\maketitle
\lstinputlisting[style=colorC++,caption={calculator.hpp}]{./calculator.hpp}
\end{document}
